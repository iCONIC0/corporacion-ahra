import { inject, unref, hasInjectionContext, getCurrentInstance, version, defineAsyncComponent, defineComponent, h, computed, ref, provide, shallowReactive, watch, Suspense, Fragment, createApp, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, mergeProps, getCurrentScope, withCtx, nextTick, useSSRContext } from 'file:///home/iCONIC0/corporacion-ahra/node_modules/vue/index.mjs';
import { $fetch } from 'file:///home/iCONIC0/corporacion-ahra/node_modules/ofetch/dist/node.mjs';
...
import { sanitizeStatusCode, createError as createError$1, appendHeader } from 'file:///home/iCONIC0/corporacion-ahra/node_modules/h3/dist/index.mjs';
import { getActiveHead, CapoPlugin } from 'file:///home/iCONIC0/corporacion-ahra/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///home/iCONIC0/corporacion-ahra/node_modules/@unhead/shared/dist/index.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'file:///home/iCONIC0/corporacion-ahra/node_modules/vue-router/dist/vue-router.node.mjs';
import { toRouteMatcher, createRouter as createRouter$1 } from 'file:///home/iCONIC0/corporacion-ahra/node_modules/radix3/dist/index.mjs';
import { defu } from 'file:///home/iCONIC0/corporacion-ahra/node_modules/defu/dist/defu.mjs';
import { withQuery, hasProtocol, isScriptProtocol, joinURL } from 'file:///home/iCONIC0/corporacion-ahra/node_modules/ufo/dist/index.mjs';
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file:///home/iCONIC0/corporacion-ahra/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "apoyanos",
    path: "/apoyanos",
    component: () => import('./apoyanos-Ba4RanGN.mjs')
  },
  {
    name: "contacto",
    path: "/contacto",
    component: () => import('./contacto-CftGpAyv.mjs')
  },
  {
    name: "equipo",
    path: "/equipo",
    component: () => import('./equipo-lopqhzFV.mjs')
  },
  {
    name: "estados-financieros",
    path: "/estados-financieros",
    component: () => import('./estados-financieros-C1Xuz3vI.mjs')
  },
  {
    name: "historia",
    path: "/historia",
    component: () => import('./historia-C2IYS-7a.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DEngX4ah.mjs')
  },
  {
    name: "mision-vision",
    path: "/mision-vision",
    component: () => import('./mision-vision-DgdzBHQG.mjs')
  },
  {
    name: "modelo-prevencion",
    path: "/modelo-prevencion",
    component: () => import('./modelo-prevencion-C6T_RUNP.mjs')
  },
  {
    name: "talleres-proyectos",
    path: "/talleres-proyectos",
    component: () => import('./talleres-proyectos-Ptphs0MN.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CuyepO6I.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const _Error404 = defineAsyncComponent(() => import('./error-404-sxGZzt7k.mjs'));
...
export { _export_sfc as _, useNuxtApp as a, resolveRouteObject as b, useRuntimeConfig as c, nuxtLinkDefaults as d, entry$1 as default, injectHead as i, navigateTo as n, resolveUnrefHeadInput as r, useRouter as u };
